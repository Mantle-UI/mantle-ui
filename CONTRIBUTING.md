...
- New components or features that fit the project direction
...
- Comments, commit messages, identifiers, and documentation should be in
  English.
- Follow the repository coding conventions in `CODING_STANDARDS.md`.
...
Mantle UI remains a continuation of the MIT-licensed PrimeReact v10 codebase.
