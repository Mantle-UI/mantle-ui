    ...
    return (
        <>
            <DocSectionText {...props}>
                ...
                <p>
                    Bootstrap integration with MantleUI components is achieved with unstyled mode either using global setting or for a particular component only. Visit the <Link href="/unstyled">unstyled</Link> mode documentation for getting started.
                </p>
            </DocSectionText>
        </>
    );
