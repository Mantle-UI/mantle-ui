...
export function HelpNeededDoc(props) {
    return (
        <DocSectionText {...props}>
            <p>Mantle UI is a community-driven project, and we appreciate any help you can provide. Here are some areas where you can contribute:</p>
            <h3>Issue Triage</h3>
            ...
            <p>
                ...
                <a href="https://github.com/Mantle-UI/mantle-ui/discussions" target="_blank" rel="noopener noreferrer">
                    GitHub Discussions
                </a>
                , and the{' '}
