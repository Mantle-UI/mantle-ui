    ...
    return (
        <DocSectionText {...props}>
            ...
            <p>
                ...
                <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/@layer">MDN</a> to begin with. In styled mode, MantleUI wraps the built-in style classes under the <i>primereact</i> cascade layer to make the library styles easy to
