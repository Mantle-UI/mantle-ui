...
export function BasicDoc(props) {
    ...
    const setFaviconToMantleUI = () => setFavicon('https://primefaces.org/cdn/primereact/images/favicon.ico');
...
import { useFavicon } from '@mantle-ui/react/hooks';
...
export default function BasicDemo() {
    ...
    return (
        <div className="card flex justify-content-center gap-2">
            ...
            <Button icon="pi pi-prime" label="MantleUI" onClick={setFaviconToMantleUI} className="p-button-secondary" />
        </div>
    )
}
        `,
