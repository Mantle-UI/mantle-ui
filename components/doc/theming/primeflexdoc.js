        ...
        <>
            <DocSectionText {...props}>
                <p>
                    ...
                    tailwind however PrimeFlex has benefits like integration with MantleUI themes using CSS variables so that colors classes e.g. <i>bg-blue-500</i> receive the color code from the MantleUI theme being used. MantleUI follows the
                    CSS utility approach of PrimeFlex and currently does not provide an extended style property like <i>sx</i>. Same approach is also utilized in <a href="https://blocks.primereact.org">PrimeBlocks for MantleUI</a> project as well.
                </p>
