...
<img className="logo" alt="logo" src="/images/logo.png" data-pr-tooltip="MantleUI-Logo" height="80px" />
        `,
        javascript: `
...
export default function MouseTrackDemo() {
    return (
        <div className="card flex flex-wrap align-items-center justify-content-center gap-5">
            ...
            <Tooltip target=".logo" mouseTrack mouseTrackLeft={10} />
            <img className="logo" alt="logo" src="https://primefaces.org/cdn/primereact/images/logo.png" data-pr-tooltip="MantleUI-Logo" height="80px" />
        </div>
    );
}
        `,
