    ...
    },
    {
        ...
        description: (
            <>
                ...
                <a href="https://www.figma.com/file/two0OGwOwHfq0sdjeK34l0/Preview-%7C-Atlantis-2022?node-id=15%3A1427&t=2lNJ5EzW0xuvQWdm-1">preview the Figma file</a> before the purchase. Note that MantleUI UI components are excluded from the
...
const templateHeroData = {
    ...
    description: 'Prepare to be amazed by the remastered Atlantis for MantleUI featuring a new gorgeous dark mode for the entire layout, 7 menu modes, reusable css widgets, utilities, modern icons and many more.',
