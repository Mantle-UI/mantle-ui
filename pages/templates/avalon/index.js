...
const animationFeaturesData1 = [
    ...
    },
    {
        id: 3,
        title: 'MantleIcons',
        description: 'Avalon ships with MantleIcons, PrimeTek’s modern icon library including a wide range of icons for your applications.',
    ...
    },
    {
        ...
        description: (
            <>
                ...
                <a href="https://www.figma.com/file/LuzEn29BAxr03T2vMQ5A1y/Preview-%7C-Avalon-1.0.0?type=design&mode=design&t=ME7xK2sAYOLoKCrT-1">preview the Figma file</a> before the purchase. Note that MantleUI UI components are excluded from the
